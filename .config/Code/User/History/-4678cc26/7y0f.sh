...
apply_image_wallpaper() {
  ...
  # Generate the Vencord theme CSS based on pywal
  cp ~/.config/wal/templates/colors-discord.css ~/.cache/wal/colors-discord.css

  # Link theme to Vencord themes folder
  ln -sf ~/.cache/wal/colors-discord.css ~/.config/vesktop/themes/pywal-vencord.theme.css
